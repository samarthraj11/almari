...
@Serializable data class UserProfile(val name: String = "Samarth", val email: String = "samarth@almi.app", val handle: String = "@samarth.styles", val styleProfile: String = "Indo-street / everyday", val isDarkMode: Boolean = false)
