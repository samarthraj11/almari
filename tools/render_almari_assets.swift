...
try pngData(size: 1024, transparent: false).write(
    to: root.appendingPathComponent("iosApp/iosApp/Assets.xcassets/AppIcon.appiconset/almari-app-icon.png")
)
try pngData(size: 360, transparent: true).write(
    to: root.appendingPathComponent("iosApp/iosApp/Assets.xcassets/LaunchLogo.imageset/almari-launch-logo.png")
)
