...
fun createAlmariApi(baseUrl: String = defaultApiBaseUrl): AlmariApi {
    val client = platformHttpClient().config {
        install(ContentNegotiation) { json(Json { ignoreUnknownKeys = true; explicitNulls = false }) }
    }
    return AlmariApi(client, baseUrl.trimEnd('/'))
}

class AlmariApi(private val client: HttpClient, private val baseUrl: String) {
